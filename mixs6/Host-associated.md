...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Host-associatedMiuvig],[Host-associatedMisag],[Host-associatedMimarksS],[Host-associatedMimarksC],[Host-associatedMimag],[Host-associatedMigsVi],[Host-associatedMigsPl],[Host-associatedMigsOrg],[Host-associatedMigsEu],[Host-associatedMigsBa],[Host-associatedMe],[Host-associated&#124;ances_data:string%20%3F;biol_stat:biol_stat_enum%20%3F;genetic_mod:string%20%3F;host_common_name:string%20%3F;samp_capt_status:samp_capt_status_enum%20%3F;samp_dis_stage:string%20%3F;host_taxid:string%20%3F;host_subject_id:string%20%3F;host_age:string%20%3F;host_life_stage:string%20%3F;host_sex:host_sex_enum%20%3F;host_disease_stat:string%20%3F;chem_administration:string%20%3F;host_body_habitat:string%20%3F;host_body_site:string%20%3F;host_body_product:string%20%3F;host_tot_mass:string%20%3F;host_height:string%20%3F;host_length:string%20%3F;host_diet:string%20%3F;host_last_meal:string%20%3F;host_growth_cond:string%20%3F;host_substrate:string%20%3F;host_family_relationship:string%20%3F;host_infra_specific_name:string%20%3F;host_infra_specific_rank:string%20%3F;host_genotype:string%20%3F;host_phenotype:string%20%3F;host_body_temp:string%20%3F;host_dry_mass:string%20%3F;host_blood_press_diast:string%20%3F;host_blood_press_syst:string%20%3F;host_color:string%20%3F;host_shape:string%20%3F;gravidity:string%20%3F;perturbation:string%20%3F;samp_salinity:string%20%3F;oxy_stat_samp:oxy_stat_samp_enum%20%3F;temp:string%20%3F;organism_count:organism_count_enum%20%3F;samp_vol_we_dna_ext:string%20%3F;samp_store_temp:string%20%3F;samp_store_dur:string%20%3F;samp_store_loc:string%20%3F;misc_param:string%20%3F]^-[Host-associatedMiuvig],[Host-associated]^-[Host-associatedMisag],[Host-associated]^-[Host-associatedMimarksS],[Host-associated]^-[Host-associatedMimarksC],[Host-associated]^-[Host-associatedMimag],[Host-associated]^-[Host-associatedMigsVi],[Host-associated]^-[Host-associatedMigsPl],[Host-associated]^-[Host-associatedMigsOrg],[Host-associated]^-[Host-associatedMigsEu],[Host-associated]^-[Host-associatedMigsBa],[Host-associated]^-[Host-associatedMe])
