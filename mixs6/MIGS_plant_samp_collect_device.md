...
# Slot: MIGS_plant_samp_collect_device




URI: [mixs.vocab:MIGS_plant_samp_collect_device](https://w3id.org/mixs/vocab/MIGS_plant_samp_collect_device)


## Domain and Range

[MIGSPlant](MIGSPlant.md) ->  <sub>OPT</sub> [String](types/String.md)
